...
public function fetchUserAnalysis(Request $request)
{
    ...
    try {
           // Step 1: Get all anonymous users with responses in a single optimized query
            ...
            //     return response()->json([
            //         'status_code' => 1,
            //         'message' => 'No anonymous users with responses found.',
            //         'data' => []
            //     ], 200);
            // }
        ...
        // $responses = Response::with(['option', 'question.categories.translations' => function ($q) use ($language) {
